...
/* harmony export */ });
const prodRate = () => {
  const rates = document.querySelectorAll('.product-add__rating-star'),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (prodRate);
...
const rangeSlider = () => {
  ...
  const skipValues = [document.querySelector('.skip-value-lower'), document.querySelector('.skip-value-upper')];
...
function stepper(btn) {
  const myInput = document.querySelector('.product-one__num-input');
...
/***/ "./src/js/modules/thumbs-slider.js":
/*!*****************************************!*\
  !*** ./src/js/modules/thumbs-slider.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_top_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/top-slider */ "./src/js/modules/top-slider.js");
/* harmony import */ var _modules_video__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/video */ "./src/js/modules/video.js");
/* harmony import */ var _modules_stars__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/stars */ "./src/js/modules/stars.js");
/* harmony import */ var _modules_timer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/timer */ "./src/js/modules/timer.js");
/* harmony import */ var _modules_range_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/range-slider */ "./src/js/modules/range-slider.js");
/* harmony import */ var _modules_selects__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/selects */ "./src/js/modules/selects.js");
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/tabs */ "./src/js/modules/tabs.js");
/* harmony import */ var _modules_product_rating__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/product-rating */ "./src/js/modules/product-rating.js");
/* harmony import */ var _modules_thumbs_slider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/thumbs-slider */ "./src/js/modules/thumbs-slider.js");
/* harmony import */ var _modules_stepper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/stepper */ "./src/js/modules/stepper.js");
/* harmony import */ var _modules_blog_slider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/blog-slider */ "./src/js/modules/blog-slider.js");
...
window.addEventListener('DOMContentLoaded', () => {
  if (document.querySelector('.top-slider__inner')) {
    (0,_modules_top_slider__WEBPACK_IMPORTED_MODULE_0__["default"])('.top-slider__inner', 1);
  }
  if (document.querySelector('.promo__timer')) {
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.promo__timer', '2023-09-01');
  }
  (0,_modules_video__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_stars__WEBPACK_IMPORTED_MODULE_2__["default"])('.product-item--1 .stars i', 'active');
  (0,_modules_stars__WEBPACK_IMPORTED_MODULE_2__["default"])('.product-item--2 .stars i', 'active');
  (0,_modules_stars__WEBPACK_IMPORTED_MODULE_2__["default"])('.product-item--3 .stars i', 'active');
  (0,_modules_stars__WEBPACK_IMPORTED_MODULE_2__["default"])('.product-item--4 .stars i', 'active');
  (0,_modules_stars__WEBPACK_IMPORTED_MODULE_2__["default"])('.product-item--5 .stars i', 'active');
  (0,_modules_stars__WEBPACK_IMPORTED_MODULE_2__["default"])('.product-item--6 .stars i', 'active');
  if (document.querySelector('.filter-price')) {
    (0,_modules_range_slider__WEBPACK_IMPORTED_MODULE_4__["default"])();
  }
  (0,_modules_selects__WEBPACK_IMPORTED_MODULE_5__["default"])('.js-choice');
  if (document.querySelector('.shop-content__filter-buttons')) {
    (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_6__["default"])('.shop-content__filter-btn', '.shop-content__inner', '.shop-content__filter-buttons', 'shop-content__filter-btn--active');
  }
  if (document.querySelector('.product-tabs__item')) {
    (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_6__["default"])('.product-tabs__item', '.product-tabs__content', '.product-tabs__inner', 'product-tabs__item--active');
  }
  if (document.querySelector('.product-add__rating')) {
    (0,_modules_product_rating__WEBPACK_IMPORTED_MODULE_7__["default"])();
  }
  if (document.querySelector('.product-slide__big')) {
    (0,_modules_thumbs_slider__WEBPACK_IMPORTED_MODULE_8__["default"])();
  }
  if (document.getElementById('increment')) {
    document.getElementById('increment').addEventListener('click', e => {
      e.preventDefault();
      (0,_modules_stepper__WEBPACK_IMPORTED_MODULE_9__["default"])(document.getElementById('increment'));
    });
    document.getElementById('decrement').addEventListener('click', e => {
      e.preventDefault();
      (0,_modules_stepper__WEBPACK_IMPORTED_MODULE_9__["default"])(document.getElementById('decrement'));
    });
  }
  if (document.querySelector('.blog-page__item--slider')) {
    (0,_modules_blog_slider__WEBPACK_IMPORTED_MODULE_10__["default"])('.blog-page__item--slider', 1);
  }
